 ...
 */
final class Version20230504142653 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livres (id INT AUTO_INCREMENT NOT NULL, categorie_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, resume LONGTEXT DEFAULT NULL, prix DOUBLE PRECISION NOT NULL, image VARCHAR(255) NOT NULL, editeur VARCHAR(255) NOT NULL, date_edition DATE NOT NULL, INDEX IDX_927187A4BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
